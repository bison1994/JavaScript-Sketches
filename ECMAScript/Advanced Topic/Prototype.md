...
3、通过构造函数创建的对象，其原型即构造函数的原型对象。
	构造函数的prototype原型并不都是普通的对象，例如：
	typeof Function.prototype // "function"
	Array.isArray( Array.prototype ) // true
	但这不重要。
	比较特殊的是函数也有继承原型，注意，这里很容易混淆“函数的继承原型”与“函数的prototype原型”，它们是两回事，函数不会从自身的prototype指向的原型对象中继承任何属性或方法，所有的函数都共同继承一个原型对象，那就是Function.prototype。
       Array.__proto__ === Function.prototype // true
       Function.__proto__ === Function.prototype // true
　　Object.__proto__ === Function.prototype // true
       var f = function () { }; f.__proto__ === Function.prototype // true
	为什么函数也有继承对象，也有__proto__属性？这不奇怪，因为函数不过是可调用的对象。
